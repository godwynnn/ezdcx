...
function Footer() {
  return (
    <section className="footer_section w-[100%] min-h-[150vh]  bg-[#0B1215] flex flex-col    text-white p-[8%]" >
      ...
      <section className='flex lg:flex-row md:flex-row sm:flex-col max-sm:flex-col lg:gap-8 md:gap-6 sm:gap-4 max-sm:gap-4 h-[80vh] p-4'>
      ...
      <hr />
      <p className='font-thin'>copyright EZFRX</p>
