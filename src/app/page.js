...
return (
  <>
    ...
    <main className="relative min-h-[100vh] w-[100%]">
      ...
      <section className="section1 w-[100%] lg:h-[100vh] md:h-[120vh] bg-[#101720] grid lg:grid-cols-2 md:grid-cols-1 justify-center items-center text-white p-[8%]">
        ...
        <div ref={section_3_ref} className="lg:mt-0 sm:mt-5 max-sm:mt-20">
          <p className="lg:text-[40px] max-sm:text-[20px] md:text-[30px] sm:text-[30px]">Learn & Earn on the go</p><br />
          <p className=" lg:text-[15px] max-sm:text-[12px] font-extralight">Get ideas to follow trade on your device, stay connected and never miss an opportunity <br /> to make profit</p>
          
          <br /><br />
          <button className="btn bg-[#D8D8D8] border-none text-[#101720]">Explore</button>
      ...
      <section className="section w-[300%] h-[150vh]    bg-[#101720] justify-center items-center text-white p-[8%]" ref={anime_ref_holder}>
        ...
        <div className="flex flex-nowrap h-[100%] w-[90%] relative overflow-hidden ">
          ...
          <div className="anime_ref text-center w-[100%] relative top-0 left-0 p-24" ref={anime_ref} >
            <ReactPlayer url={'/videos/ezfrx1.mp4'} width={'100%'} height={'100%'} className='mt-0 intro_video' controls />
