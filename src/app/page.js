    ...
    <>
      <Hero>
        <main className=" min-h-[100vh] w-[100%]">
          ...
          <header className="header relative w-[100%] h-[120vh] flex lg:flex-row md:flex-col justify-center items-center  bg-[#101720] p-[2%]"   >
            <section className="h-full max-lg:w-[60%] lg:w-[60%] max-md:w-[40%] md:w-[100%] text-white flex flex-col justify-center lg:p-[5%] md:p-[10%] header_caption "  >
              <p className=" lg:text-[60px] md:text-[40px] font-[400] text-gray-200 md:text-center lg:text-left">Begin your journey to financial freedom with <span className="text-white">EZFRX</span> </p>
            ...
            <section className="h-full lg:w-[40%] md:w-[60%]  relative">
              ...
              <Image src={require('../../assets/img3.png')} className="w-[80%] absolute top-[0%] lg:h-[70%] md:h-[100%] lg:right-[20%] md:right-0" />
            </section>
          ...
          <section className="w-[100%] relative lg:h-[70vh] md:h-[90vh] sm:h-[130vh] grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 bg-[#101720] p-[4%] gap-4"   >
          ...
          <div class="wave1">
            ...
            <div className="feature p-[4%] rounded-md lg:h-[70%] md:h-[70%] sm:h-[100%] bg-gray-200 text-black" >
          ...
          <section className="relative section w-[100%] h-[180vh]  bg-gray-200 flex flex-col  justify-center items-center text-white p-[8%]">
            <div class="wave2">
              <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
